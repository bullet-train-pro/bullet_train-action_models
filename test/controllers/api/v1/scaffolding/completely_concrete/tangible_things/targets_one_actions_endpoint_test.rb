...
class Api::V1::Scaffolding::CompletelyConcrete::TangibleThings::TargetsOneActionsEndpointTest < Api::Test
  ...
  def setup
    ...
    @targets_one_action = create(:scaffolding_completely_concrete_tangible_things_targets_one_action, absolutely_abstract_creative_concept: @absolutely_abstract_creative_concept)
  ...
  def assert_proper_object_serialization(targets_one_action_data)
    ...
    assert_equal targets_one_action_data["target_all"], targets_one_action.target_all
    assert_equal targets_one_action_data["target_ids"], targets_one_action.target_ids
    ...
    assert_equal targets_one_action_data["created_by_id"], targets_one_action.created_by_id
    assert_equal targets_one_action_data["approved_by_id"], targets_one_action.approved_by_id
    ...
    assert_equal targets_one_action_data["absolutely_abstract_creative_concept_id"], targets_one_action.absolutely_abstract_creative_concept_id
  end

  test "index" do
    # Fetch and ensure nothing is seriously broken.
    get "/api/v1/scaffolding/absolutely_abstract/creative_concepts/#{@absolutely_abstract_creative_concept.id}/completely_concrete/tangible_things/targets_one_actions", params: {access_token: access_token}
  ...
  test "create" do
    ...
    targets_one_action_data = Api::V1::Scaffolding::CompletelyConcrete::TangibleThings::TargetsOneActionSerializer.new(build(:scaffolding_completely_concrete_tangible_things_targets_one_action, absolutely_abstract_creative_concept: nil)).serializable_hash.dig(:data, :attributes)
    targets_one_action_data.except!(:id, :absolutely_abstract_creative_concept_id, :created_at, :updated_at)

    post "/api/v1/scaffolding/absolutely_abstract/creative_concepts/#{@absolutely_abstract_creative_concept.id}/completely_concrete/tangible_things/targets_one_actions",
