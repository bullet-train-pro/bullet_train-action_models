FactoryBot.define do
  factory :scaffolding_completely_concrete_tangible_things_performs_import_action, class: "Scaffolding::CompletelyConcrete::TangibleThings::PerformsImportAction" do
