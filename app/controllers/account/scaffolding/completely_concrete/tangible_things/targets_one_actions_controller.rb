class Account::Scaffolding::CompletelyConcrete::TangibleThings::TargetsOneActionsController < Account::ApplicationController
  account_load_and_authorize_resource :targets_one_action, through: :tangible_thing, through_association: :completely_concrete_tangible_things_targets_one_actions, member_actions: [:approve]

  # GET /account/scaffolding/absolutely_abstract/creative_concepts/:absolutely_abstract_creative_concept_id/completely_concrete/tangible_things/targets_one_actions
  # GET /account/scaffolding/absolutely_abstract/creative_concepts/:absolutely_abstract_creative_concept_id/completely_concrete/tangible_things/targets_one_actions.json
  def index
  ...
  # GET /account/scaffolding/absolutely_abstract/creative_concepts/:absolutely_abstract_creative_concept_id/completely_concrete/tangible_things/targets_one_actions/new
  def new
  end
  ...
  # POST /account/scaffolding/absolutely_abstract/creative_concepts/:absolutely_abstract_creative_concept_id/completely_concrete/tangible_things/targets_one_actions
  # POST /account/scaffolding/absolutely_abstract/creative_concepts/:absolutely_abstract_creative_concept_id/completely_concrete/tangible_things/targets_one_actions.json
  def create
    respond_to do |format|
      ...
      if @targets_one_action.save
        format.html { redirect_to [:account, @absolutely_abstract_creative_concept, :completely_concrete_tangible_things_targets_one_actions], notice: I18n.t("scaffolding/completely_concrete/tangible_things/targets_one_actions.notifications.created") }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to [:account, @absolutely_abstract_creative_concept, :completely_concrete_tangible_things_targets_one_actions], notice: I18n.t("scaffolding/completely_concrete/tangible_things/targets_one_actions.notifications.destroyed") }
