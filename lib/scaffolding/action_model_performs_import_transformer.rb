...
class Scaffolding::ActionModelPerformsImportTransformer < Scaffolding::ActionModelTransformer
  ...
  def scaffold_action_model
    ...
    scaffold_add_line_to_file(
      ...
      "has_many :completely_concrete_tangible_things_#{targets_n}_actions, class_name: \"Scaffolding::CompletelyConcrete::TangibleThings::PerformsImportAction\", dependent: :destroy, foreign_key: :absolutely_abstract_creative_concept_id, enable_updates: true, inverse_of: :absolutely_abstract_creative_concept",
      HAS_MANY_HOOK,
      prepend: true
    )
