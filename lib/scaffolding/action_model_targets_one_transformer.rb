...
class Scaffolding::ActionModelTargetsOneTransformer < Scaffolding::ActionModelTransformer
  ...
  def add_has_many_to_parent_model
    ...
    scaffold_add_line_to_file(
      ...
      "has_many :targets_one_actions, class_name: \"Scaffolding::CompletelyConcrete::TangibleThings::TargetsOneAction\", dependent: :destroy, foreign_key: :tangible_thing_id, enable_cable_ready_updates: true, inverse_of: :tangible_thing",
      HAS_MANY_HOOK,
      prepend: true
    )
  end
